...
const {RIGHTS, CHECKED: RIGHTS_CHECKED} = require("./rights");
const ISSUERS = [
  {
...
async function board(){
  ...
  return {
    ...
    issuers: ISSUERS.map(({id, name, short, url, about}) => ({id, name, short, url, about, rights: RIGHTS[id] || null})),
    rightsChecked: RIGHTS_CHECKED,
